...
sim_data <- read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/ex_ante_simulation_2lrates.txt", 
                       " ", col_names = F, 
                       trim_ws = TRUE)
...
parameter_sim <- 
  read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/ex_ante_simulation_parameters_2lrates.txt", 
             " ", col_names = F, 
             trim_ws = TRUE)
...
recovery_2lrates <- write.table(recovery_df, file = "ex_ante_recovery_2lrates_4blocks_100trials.txt", 
                        row.names = FALSE, col.names = FALSE)

modelfit_2lrates <- write.table(recovery_df, file = "ex_ante_modelfit_2lrates_4blocks_100trials.txt", 
                                row.names = FALSE, col.names = FALSE)
