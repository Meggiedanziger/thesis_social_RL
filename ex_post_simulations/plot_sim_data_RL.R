...
sim_post <- read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/ex_post_simulations/simulation_weightstandard_18_30.txt", 
                       " ", escape_double = FALSE, col_names = F, 
                       trim_ws = TRUE)
...
test_data <- cbind(sim_data_sum, sim_post_sum)
...
# 
# #read in ex post simulated data standard RL model
# sim_post <- read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/ex_post_simulations/simulation_standard_24_30.txt", 
#                        " ", escape_double = FALSE, col_names = F, 
#                        trim_ws = TRUE)
# 
# names(sim_post)[1] <- "id_post"
