...
#read in data
sim_data <- 
  read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/simulated_agents/agents_standard_RL_24blocks_30trials.txt", 
             " ", col_names = F, 
             trim_ws = TRUE)
...
parameter_sim <- 
  read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/simulated_agents/agents_standard_RL_24blocks_30trials_parameters.txt", 
             " ", col_names = F, 
             trim_ws = TRUE)
...
modelfit_standard <- write.table(recovery_df, file = "modelfit_agents_standard_RL_24blocks_30trials.txt", 
