...
sim_data <- 
  read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/simulated_agents/agents_weight_6_30_30ppts.txt", 
                       " ", col_names = F, 
                       trim_ws = TRUE)
...
parameter_sim <- 
  read_delim("~/Dropbox/___MA/social_RL_git/thesis_social_RL/simulated_agents/agents_weight_parameters_30ppts.txt", 
                       " ", col_names = F, 
                       trim_ws = TRUE)
...
setwd("~/Dropbox/___MA/social_RL_git/thesis_social_RL/simulated_agents")
modelfit_standard <- write.table(recovery_df, file = "modelfit_agents_weight_6_30_30ppts.txt", 
