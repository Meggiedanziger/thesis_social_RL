...
cchoice      <- array(0, c(125, 12, 100))
R            <- array(0, c(125, 12, 100))
Prob         <- array(0, c(125, 12, 100))
Feed         <- array(0, c(125, 12, 100))
Feed_c       <- array(0, c(125, 12, 100))
Feed_i       <- array(0, c(125, 12, 100))
Prob_correct <- array(0, c(125, 12, 100))
PE <- Q_all  <- array(0, c(125, 12, 100))
...
sim_data <- write.table(merged_dat, file = "ex_ante_simulation_2lrates_12blocks_100trials.txt", 
                        row.names = FALSE, col.names = FALSE)

params_exante <- write.table(FIT, file = "ex_ante_simulation_parameters_2lrates_12blocks_100trials.txt", 
                             row.names = FALSE, col.names = FALSE)
