...
cchoice <-  array(0, c(100, 4, 12))

#Q <- matrix(0,1,2) 
R <- array(0, c(100, 4, 12))

Prob         <- array(0, c(100, 4, 12))
Feed         <- array(0, c(100, 4, 12))
Feed_c       <- array(0, c(100, 4, 12))
Feed_i       <- array(0, c(100, 4, 12))
Prob_correct <- array(0, c(100, 4, 12))
PE <- Q_all  <- array(0, c(100, 4, 12))

id    <- rep(1:10, each = 10)
temp  <- rep(1:10, each = 1)/10
lrate <- rep(1:10, each = 10)/10
...
sim_data <- write.table(merged_dat, file = "simulation_alpha_beta_combinations.txt", 
