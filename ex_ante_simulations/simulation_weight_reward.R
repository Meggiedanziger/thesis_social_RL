...
cchoice      <- array(0, c(250, 12, 60))
R            <- array(0, c(250, 12, 60))
Prob         <- array(0, c(250, 12, 60))
Feed         <- array(0, c(250, 12, 60))
Feed_c       <- array(0, c(250, 12, 60))
Feed_i       <- array(0, c(250, 12, 60))
Prob_correct <- array(0, c(250, 12, 60))
PE <- Q_all  <- array(0, c(250, 12, 60))
...
sim_data <- write.table(merged_dat, file = "simulation_weight_model_12blocks_60trials.txt", 
                        row.names = FALSE, col.names = FALSE)

params_exante <- write.table(FIT, file = "parameters_weight_model_12blocks_60trials.txt", 
                             row.names = FALSE, col.names = FALSE)
